...
public class PurchaseController {
	...
	public String updateTranCode(@RequestParam("prodNo") int prodNo, @ModelAttribute("purchase") Purchase purchase , Model model , HttpServletRequest request,HttpSession session) throws Exception{
		
		// 상품번호로 주문상태코드 변경
		PurchaseService service = new PurchaseServiceImpl();
		service.getPurchase2(prodNo);
		...
		return "redirect:/product/listProduct.jsp?menu="+request.getParameter("menu");
	}
	...
	public String updateTranCodeByTranNo(@RequestParam("tranNo") int tranNo,
		...
		//Business Logic
		System.out.println("prodNo");
		//purchaseService.updateTranCode();
